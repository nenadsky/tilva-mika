 ...
 ?>
 	...
 	<main id="primary" class="site-main">
 				...
 				<?php
 					...
 					if ( $tilvamika_description || is_customize_preview() ) :
 						...
 						<div class="site-desc-text">
 							<div id="description" class="site-description"><?php echo $tilvamika_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></div>
 							<div id="cursor"></div>
 						</div>
 		...
 		<?php
 			...
 			$the_query_cat1 = apply_filters('most_recent', '', 'razmisljanja');
 			$the_query_cat2 = apply_filters('most_recent', '', 'programiranje');
         ?>
 			...
 			<div class="recent--posts--container">
 			 ...
 			 <?php
 				...
 				<div class="section-title">
 					<a  href=" <?php echo get_permalink( 23 ); ?> "><h2 class="header-title"><ion-icon name="folder"></ion-icon> &#91; &#47; &#93;</h2></a>
 				</div>
 				...
 				<div class="section-title">
 					<a href=" <?php echo get_category_link( 16 ); ?> "><ion-icon name="folder"></ion-icon> &#91; <?php echo get_cat_name($category_id =16); ?> &#93;</a>
 				</div>
 			...
 			<div class="portfolio--container">
 				...
 				<div class="project project--2">
 					<div class="project-container">
 						...
 						<?php $img = apply_filters('display_default_featured_img', 122, 'fullsize'); ?>
 						<a href="http://alkamaks.mk/"><img class="portfolio-image" src="<?php echo $img[0]; ?>" alt="Alka Maks mesara"></a>
 					</div>
 				</div>
 		...
 		<section id="social" class="section-container">
 			<div class="social-container">
 				<a class="twitter" href="https://twitter.com/nenadsky"><ion-icon name="logo-twitter"></ion-icon></a>
 				<a class="linkedin" href="https://www.linkedin.com/in/nenad-dimitrovski/?lipi=urn%3Ali%3Apage%3Ad_flagship3_feed%3Bdio05yraTAe3YzfY66Gxxg%3D%3D"><ion-icon name="logo-linkedin"></ion-icon></a>
 				<a class="mail" href="mailto:email@nenadsky.com"><ion-icon name="mail"></ion-icon></a>
 				<a class="github" href="https://github.com/nenadsky"><ion-icon name="logo-github"></ion-icon></a>
 			</div>
 		</section>
